...
from x_follower_analyzer.models.user import FollowerAnalysis, UserProfile, Tweet, LikedTweet
...
def generate_demo_data(count: int = 50) -> List[FollowerAnalysis]:
    ...
    locations = [
        ...
        "Seattle, WA", "Boston, MA", "Chicago, IL", "Miami, FL", "Denver, CO",
        "Global", "United States", "Canada", "United Kingdom", "Germany", 
        "Japan", "South Korea", "Australia", "India", "Brazil", "France",
        None, None, None  # Some users don't have location
    ]
    
    tech_hashtags = [
        "Tesla", "SpaceX", "AI", "MachineLearning", "Crypto", "Bitcoin", 
        "Ethereum", "Tech", "Innovation", "Future", "Mars", "ElectricCars",
        "Neuralink", "Starlink", "Programming", "Python", "JavaScript",
    ...
    usernames = [
        "techfan2024", "spacelover88", "cryptohodler", "airesearcher", "marsexplorer",
        "cleanenergyadvocate", "futurist2024", "techentrepreneur", "spacenerd", 
        "electriccarfan", "blockchain_dev", "ml_engineer", "crypto_trader",
        "tech_innovator", "space_enthusiast", "ai_researcher", "future_builder",
        "clean_tech_fan", "mars_colonist", "tech_visionary", "innovation_seeker",
        "digital_nomad", "startup_founder", "tech_investor", "space_fan"
    ]
    
    display_names = [
        "Tech Enthusiast", "Space Explorer", "Crypto Trader", "AI Researcher",
        "Mars Explorer", "Clean Energy Advocate", "Future Visionary", "Tech Entrepreneur",
        "Space Nerd", "Electric Car Fan", "Blockchain Developer", "ML Engineer",
        "Digital Asset Pro", "Innovation Expert", "Space Enthusiast", "AI Scientist",
        "Future Builder", "CleanTech Fan", "Mars Colonist", "Tech Visionary"
    ]
