...
def main():
    ...
    charts = {
        "follower_distribution": chart_generator.create_follower_distribution_chart(demo_analyses),
        "verification_status": chart_generator.create_verification_pie_chart(demo_analyses),
        "location_analysis": chart_generator.create_location_analysis_chart(demo_analyses),
        "engagement_analysis": chart_generator.create_engagement_analysis_chart(demo_analyses),
        "hashtag_wordcloud": chart_generator.create_hashtag_wordcloud(demo_analyses),
        "activity_timeline": chart_generator.create_activity_timeline_chart(demo_analyses),
    }
